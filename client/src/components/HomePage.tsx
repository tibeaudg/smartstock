         ...
         <div className="relative px-4 sm:px-6 lg:px-8 z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: 'easeOut' }}>
               ...
               <p className="max-w-2xl mx-auto text-lg md:text-xl text-gray-600 mb-10">
                  <strong>Geen</strong> betalingsgegevens vereist.
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <FadeInWhenVisible>
               <div className="text-center mb-16">
                  <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4 tracking-tight">De juiste tools voor een vlekkeloos stockbeheer</h2>
               </div>
            </FadeInWhenVisible>
