...
-- This migration ensures all analytics tables are created if they don't exist
...
DROP POLICY IF EXISTS "Users can insert their own analytics cache" ON public.analytics_cache;
DROP POLICY IF EXISTS "Users can update their own analytics cache" ON public.analytics_cache;
DROP POLICY IF EXISTS "Users can delete their own analytics cache" ON public.analytics_cache;
...
DROP POLICY IF EXISTS "Users can update their own analytics queries" ON public.analytics_queries;
DROP POLICY IF EXISTS "Users can delete their own analytics queries" ON public.analytics_queries;

DROP POLICY IF EXISTS "Users can view their own analytics reports" ON public.analytics_reports;
DROP POLICY IF EXISTS "Users can insert their own analytics reports" ON public.analytics_reports;
DROP POLICY IF EXISTS "Users can update their own analytics reports" ON public.analytics_reports;
DROP POLICY IF EXISTS "Users can delete their own analytics reports" ON public.analytics_reports;

DROP POLICY IF EXISTS "Users can view their own analytics predictions" ON public.analytics_predictions;
DROP POLICY IF EXISTS "Users can insert their own analytics predictions" ON public.analytics_predictions;
DROP POLICY IF EXISTS "Users can update their own analytics predictions" ON public.analytics_predictions;
DROP POLICY IF EXISTS "Users can delete their own analytics predictions" ON public.analytics_predictions;

DROP POLICY IF EXISTS "Users can view their own analytics api keys" ON public.analytics_api_keys;
DROP POLICY IF EXISTS "Users can insert their own analytics api keys" ON public.analytics_api_keys;
DROP POLICY IF EXISTS "Users can update their own analytics api keys" ON public.analytics_api_keys;
DROP POLICY IF EXISTS "Users can delete their own analytics api keys" ON public.analytics_api_keys;

DROP POLICY IF EXISTS "Users can view their own analytics api usage" ON public.analytics_api_usage;
DROP POLICY IF EXISTS "Users can insert their own analytics api usage" ON public.analytics_api_usage;

DROP POLICY IF EXISTS "Users can view their own analytics filters" ON public.analytics_filters;
DROP POLICY IF EXISTS "Users can insert their own analytics filters" ON public.analytics_filters;
DROP POLICY IF EXISTS "Users can update their own analytics filters" ON public.analytics_filters;
DROP POLICY IF EXISTS "Users can delete their own analytics filters" ON public.analytics_filters;

DROP POLICY IF EXISTS "Users can view their own analytics export jobs" ON public.analytics_export_jobs;
DROP POLICY IF EXISTS "Users can insert their own analytics export jobs" ON public.analytics_export_jobs;
DROP POLICY IF EXISTS "Users can update their own analytics export jobs" ON public.analytics_export_jobs;
DROP POLICY IF EXISTS "Users can delete their own analytics export jobs" ON public.analytics_export_jobs;
...
-- Create triggers for updated_at if the function exists
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'update_updated_at_column') THEN
        ...
        DROP TRIGGER IF EXISTS update_analytics_queries_updated_at ON public.analytics_queries;
        CREATE TRIGGER update_analytics_queries_updated_at
            BEFORE UPDATE ON public.analytics_queries
            FOR EACH ROW
            EXECUTE FUNCTION update_updated_at_column();

        DROP TRIGGER IF EXISTS update_analytics_predictions_updated_at ON public.analytics_predictions;
        CREATE TRIGGER update_analytics_predictions_updated_at
            BEFORE UPDATE ON public.analytics_predictions
            FOR EACH ROW
            EXECUTE FUNCTION update_updated_at_column();

        DROP TRIGGER IF EXISTS update_analytics_api_keys_updated_at ON public.analytics_api_keys;
        CREATE TRIGGER update_analytics_api_keys_updated_at
            BEFORE UPDATE ON public.analytics_api_keys
            FOR EACH ROW
            EXECUTE FUNCTION update_updated_at_column();

        DROP TRIGGER IF EXISTS update_analytics_filters_updated_at ON public.analytics_filters;
