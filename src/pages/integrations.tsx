  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO
        ...
        description="Connect StockFlow with Shopify, Stripe, e-commerce platforms, and business tools. Sync inventory, orders, and data across your stack."
      ...
      <div className="pt-40 bg-gradient-to-br from-blue-600 to-blue-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Powerful Integrations</h1>
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Connect StockFlow with the tools you already use to keep inventory, orders, and operations in sync.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <Card key={integration.name} className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center justify-between mb-4">
                  <div className="p-3 bg-blue-100 rounded-lg text-blue-600">{integration.icon}</div>
                  <Badge
        ...
        <div className="mt-16 text-center space-y-4">
          <p className="text-gray-600">Explore more ways StockFlow fits your workflow.</p>
