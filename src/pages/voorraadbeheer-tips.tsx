...
export default function VoorraadbeheerTips() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-12">
      <SEO
        title="Voorraadbeheer Tips voor KMO's | SmartStock"
        description="De beste tips voor voorraadbeheer, stockbeheer en magazijnbeheer voor KMO's. Leer hoe je efficiënt je voorraad beheert en kosten bespaart met SmartStock."
        ...
        url="https://www.smartstock.be/voorraadbeheer-tips"
      />
      ...
      <p className="mb-4">Gebruik een moderne <strong>voorraadbeheer app</strong> zoals SmartStock om altijd en overal inzicht te hebben in je voorraad. Dit voorkomt fouten en bespaart tijd.</p>
      ...
      <p className="mb-4">Start gratis met SmartStock en upgrade eenvoudig als je bedrijf groeit. Zo betaal je nooit te veel.</p>
      ...
      <ul className="list-disc ml-6 mb-4">
        ...
        <li><strong>Welke software is geschikt voor kleine bedrijven?</strong> SmartStock is speciaal ontwikkeld voor KMO's en zelfstandigen.</li>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{
        ...
        "mainEntityOfPage": { "@type": "WebPage", "@id": "https://www.smartstock.be/voorraadbeheer-tips" },
