                      ...
                      <div key={index} className="border rounded-lg p-4 space-y-4 bg-white">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                          ...
                          <div>
                            ...
                            <IntegerInput min={0} value={item.counted_quantity} onChange={counted_quantity => updateItem(index, { counted_quantity })} className="mt-1 border-blue-300 focus:ring-blue-500" />
                          </div>
                        </div>
