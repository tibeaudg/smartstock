  ...
  const seoCategories = [
    {
      ...
      pages: [
        ...
        { name: "Inventory Management Software", url: "/solutions/inventory-management-software" },
        { name: "Inventory Software", url: "/solutions/inventory-software" },
        { name: "Inventory Software Management", url: "/solutions/inventory-software-management" },
        { name: "Inventory Management Provider", url: "/solutions/inventory-management-provider" },
        { name: "Inventory Management Software Solutions", url: "/solutions/inventory-management-software-solutions" },
        { name: "Inventory Management Systems Solutions", url: "/solutions/inventory-management-systems-solutions" },
        { name: "Inventory Software for Small Business", url: "/solutions/inventory-system-for-small-business" },
        { name: "Software for Inventory Management", url: "/solutions/software-for-inventory-management" },
        ...
        { name: "Online Inventory Management", url: "/solutions/online-inventory-management" },
        { name: "Online Inventory Software", url: "/solutions/online-inventory-software" },
        ...
        { name: "Inventory Tracker", url: "/solutions/inventory-tracker" },
        ...
        { name: "Mobile Inventory Management", url: "/solutions/mobile-inventory-management" },
    ...
    },
    {
      ...
      icon: BarChart3,
      pages: [
        { name: "Stock Management", url: "/solutions/stock-management" },
        ...
        { name: "Simple Stock Management", url: "/solutions/simple-stock-management" },
