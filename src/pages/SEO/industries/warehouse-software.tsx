    ...
    >
      ...
      <section id="roi" className="py-16 px-4 bg-gradient-to-br from-blue-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              The best warehouse software delivers measurable returns. Calculate your potential savings with our interactive ROI calculator.
            </p>
          </div>

          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h3 className="text-2xl font-bold mb-6 text-center">Interactive ROI Calculator</h3>
            <p className="text-center text-gray-600 mb-8">Enter your numbers to see potential savings with StockFlow warehouse software</p>
      ...
      <section id="video-demo" className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              See StockFlow Warehouse Software in Action
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Watch how the best warehouse software helps businesses automate operations, optimize picking routes, and reduce costs.
            </p>
          </div>
          <div className="max-w-4xl mx-auto">
            <div className="bg-gray-900 rounded-lg aspect-video flex items-center justify-center relative overflow-hidden">
              <div className="text-center text-white z-10">
                ...
                <p className="text-lg font-semibold mb-2">Warehouse Software Demo Video</p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg p-8 text-white text-center">
            ...
            <p className="text-lg mb-6 opacity-90">
              Get our comprehensive 25-page guide: "How to Choose the Best Warehouse Software in 2025"
            </p>
            <div className="grid md:grid-cols-2 gap-4 mb-6 text-left">
              ...
              <div className="bg-white/10 rounded-lg p-4">
                ...
                <ul className="text-sm space-y-1 opacity-90">
                  <li>✓ How to evaluate warehouse software</li>
