...
export default function StockFlowVsSkuVault() {
  usePageRefresh();
  ...
  const comparisonFeatures: ComparisonFeature[] = [
    ...
    { feature: 'Starting Price', stockflow: 'Free', competitor: '$499/month' },
  ];

  return (
    <SeoPageLayout title="StockFlow vs SkuVault">
      <SEO
        title="StockFlow vs SkuVault: Affordable Alternative for SMEs 2025"
        description="SkuVault is enterprise-priced. StockFlow offers what small businesses need at a fraction of the cost. Start free today."
        keywords="stockflow vs skuvault, skuvault alternative"
        url="https://www.stockflow.be/stockflow-vs-skuvault"
      />
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <ComparisonTable competitorName="SkuVault" features={comparisonFeatures} />
        </div>
      </section>

      <section className="py-16 px-4 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Save $5,988+ Annually</h2>
