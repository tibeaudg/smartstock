        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              <img 
                src="/mobile.png" 
                alt="Mobile inventory management app showing barcode scanning, real-time stock tracking, and offline capabilities on smartphone"
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Link to="/mobile-app" className="group">
              <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-lg transition">
                ...
                <div className="text-blue-600 text-sm font-semibold">View app â†’</div>
              </div>
            </Link>
          </div>
        </div>
