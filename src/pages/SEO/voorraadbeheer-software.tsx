...
export default function VoorraadbeheerSoftware() {
  ...
  const faqData = [
    {
      ...
      answer: "Voorraadbeheer software is een digitaal systeem dat helpt bij het beheren van je voorraad. Het houdt bij hoeveel producten je hebt, wanneer je moet bestellen en helpt bij het optimaliseren van je magazijnoperaties."
    },
    {
      question: "Is er gratis voorraadbeheer software beschikbaar?",
      answer: "Ja, stockflow biedt gratis voorraadbeheer software voor kleine bedrijven. Je kunt tot 30 producten gratis beheren zonder verborgen kosten of verplichtingen."
    },
    {
    ...
    },
    {
      ...
      answer: "Voorraadbeheer software werkt door je producten digitaal bij te houden, automatische meldingen te geven bij lage voorraad en real-time inzicht te bieden in je voorraadniveaus en verkopen."
    },
    {
      question: "Kan ik voorraadbeheer software integreren met mijn bestaande systemen?",
      answer: "Ja, moderne voorraadbeheer software zoals stockflow kan vaak geïntegreerd worden met boekhoudsoftware, webshops en andere bedrijfssystemen voor een naadloze workflow."
    }
  ];
  ...
  return (
    <SeoPageLayout title="Voorraadbeheer Software voor KMO's">
      <SEO
        title="Gratis Voorraadbeheer Software voor KMO's | stockflow"
        description="Beheer je voorraad eenvoudig online. Gratis voorraadbeheer software voor winkels, horeca en zelfstandigen. Start direct met stockflow – geen kosten."
        keywords="voorraadbeheer software, gratis voorraadbeheer, stockbeheer software, voorraadbeheer programma, magazijnbeheer software, inventarisatie software, voorraadbeheer app, stockbeheer app, stockflow, gratis stockbeheer, KMO software, kleine onderneming software"
          ...
          <div className="grid lg:grid-cols-3 gap-6 sm:gap-8 items-center">
            ...
            <div className="lg:col-span-2">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6">
                <span className="text-blue-600">Gratis Voorraadbeheer Software</span> voor KMO's
              </h1>
          ...
          <div className="grid lg:grid-cols-3 gap-6 sm:gap-8 items-center">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6">
                Waarom kiezen voor professionele voorraadbeheer software?
              </h2>
              <p className="text-sm sm:text-base md:text-lg text-gray-700 mb-4 sm:mb-6 leading-relaxed">
                Voorraadbeheer software is essentieel voor moderne bedrijven. In plaats van handmatig bijhouden in Excel of op papier, biedt professionele voorraadbeheer software real-time inzicht, automatische meldingen en geavanceerde rapportage. Dit bespaart tijd, voorkomt fouten en optimaliseert je voorraadniveaus.
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">
              <span className="text-blue-600">Functies</span> van onze voorraadbeheer software
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Ontdek alle mogelijkheden van onze voorraadbeheer software die speciaal is ontwikkeld voor kleine ondernemers
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-700">
                Groei mee met je bedrijf. Van 30 producten tot duizenden - onze voorraadbeheer software schaalt automatisch mee.
              </p>
            </div>
          </div>
        </div>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{
        ...
        "description": "Gratis voorraadbeheer software voor kleine ondernemers. Beheer je voorraad eenvoudig online.",
