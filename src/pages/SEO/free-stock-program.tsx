...
export default function FreeStockProgram() {
  usePageRefresh();
  
  return (
    <SeoPageLayout title="Free Stock Program">
      <SEO
        ...
        url="https://www.stockflow.be/free-stock-program"
      />
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Free Stock Program: <span className="text-blue-600">Complete Stock Management Without the Price Tag</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Download free stock management program. Easy to use, powerful features, no hidden costs.
              </p>
