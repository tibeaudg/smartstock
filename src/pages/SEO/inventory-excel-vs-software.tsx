...
export default function InventoryExcelVsSoftware() {
  usePageRefresh();
  
  return (
    <SeoPageLayout title="Excel vs Inventory Software">
      <SEO
        ...
        url="https://www.stockflow.be/inventory-excel-vs-software"
      />
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Excel vs Inventory Software: <span className="text-blue-600">Making the Right Choice for Your Business</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Excel or inventory software? Compare features, costs, and benefits. Make the right choice for your business.
              </p>
            ...
            <div>
              <img 
                ...
                alt="Excel vs Inventory Software" 
