...
export default function ProgrammaStockbeheerGratis() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Ons programma stockbeheer gratis bevat alle essentiële functies: real-time voorraadoverzicht, automatische bestelmeldingen, barcode scanning, team samenwerking, rapportages, en integratie met andere systemen. Alles wat je nodig hebt voor professioneel stockbeheer zonder kosten."
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  to="/demo-aanvragen"
                  className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-purple-600 transition text-center"
                >
                  Demo Aanvragen
                </Link>
              </div>
