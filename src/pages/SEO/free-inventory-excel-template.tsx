...
export default function FreeInventoryExcelTemplate() {
  usePageRefresh();
  
  return (
    <SeoPageLayout title="Free Inventory Excel Template">
      <SEO
        ...
        url="https://www.stockflow.be/free-inventory-excel-template"
      />
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Free Inventory Excel Template: <span className="text-blue-600">Ready-Made Templates for Stock Tracking</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Download free inventory Excel templates. Ready-to-use spreadsheets for stock management. Or switch to better software.
              </p>
            ...
            <div>
              <img 
                ...
                alt="Free Inventory Excel Template" 
