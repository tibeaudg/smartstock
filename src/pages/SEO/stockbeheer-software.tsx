...
export default function StockbeheerSoftware() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Ja, moderne stockbeheer software zoals stockflow kan vaak geïntegreerd worden met boekhoudsoftware, webshops en andere bedrijfssystemen voor een naadloze workflow. Dit maakt het mogelijk om orderbeheer, voorraadbeheer en rapportage te automatiseren tussen verschillende systemen."
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Stockbeheer software biedt essentiële functies om je voorraad optimaal te beheren
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-lg border border-green-200">
              ...
              <p className="text-gray-700">
                Organiseer en optimaliseer de magazijnlogistiek. Beheer locaties, tracking van artikelen en efficiënte picking- en packingprocessen voor optimale magazijnoperaties.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <p className="text-gray-700">
                Scan barcodes met je smartphone of tablet voor snelle en nauwkeurige voorraadupdates. Perfect voor efficiënt magazijnbeheer en orderbeheer.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <p className="text-gray-700">
                Beheer voorraad op meerdere locaties vanuit één centrale stockbeheer software. Ideaal voor bedrijven met meerdere vestigingen of magazijnen.
              </p>
            </div>
