...
export default function InventoryManagementHospitality() {
  usePageRefresh();
  
  return (
    <SeoPageLayout title="Inventory Management for Hospitality">
      <SEO
        ...
        url="https://www.stockflow.be/inventory-management-hospitality"
      />
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Inventory Management for Hospitality: <span className="text-blue-600">Tailored for Hotels, Restaurants & More</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Specialized inventory management for hotels, restaurants, and hospitality. Reduce waste, control costs, improve service.
              </p>
            ...
            <div>
              <img 
                ...
                alt="Inventory Management for Hospitality" 
