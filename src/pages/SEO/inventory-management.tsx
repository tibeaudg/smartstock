          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Inventory management is the systematic approach to sourcing, storing, and selling inventory—both raw materials (components) and finished goods (products). It involves tracking inventory from purchase to sale, ensuring that the right amount of stock is available at the right time.
              </p>
