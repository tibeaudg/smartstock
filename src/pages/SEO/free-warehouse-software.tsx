...
export default function FreeWarehouseSoftware() {
  usePageRefresh();
  
  return (
    <SeoPageLayout title="Free Warehouse Software">
      <SEO
        ...
        url="https://www.stockflow.be/free-warehouse-software"
      />
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Free Warehouse Software: <span className="text-blue-600">Professional Warehouse Management at No Cost</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Free warehouse software for small businesses. Manage locations, track movements, optimize warehouse operations.
              </p>
