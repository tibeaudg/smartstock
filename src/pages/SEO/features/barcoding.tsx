...
const features = [
  ...
  },
  {
    ...
    description: 'Track barcoding activity, top movers, and exceptions with dashboards built for operations and finance.'
  },
  {
    icon: <ListChecks className="h-6 w-6" />,
    title: 'Workflow Automation',
    description: 'Trigger pick lists, replenishment alerts, and quality checks with configurable barcoding-driven rules.'
  }
];
...
const workflowSteps = [
  {
    ...
    description: 'Open StockFlow on any secure device and choose the barcoding workflow that matches your task.'
  },
  {
  ...
  },
  {
    ...
    description: 'Updates flow instantly to inventory, fulfillment, and analytics with audit trails for every barcoding.'
  }
];
...
const useCases = [
  {
    ...
    points: [
      ...
      'Empower associates with guided barcoding flows and smart prompts.'
    ]
  },
  {
    ...
    points: [
      'Capture lot, batch, and expiration data as you barcoding.',
      'Generate audit-ready trails automatically for every adjustment.',
      'Run investigations faster with search-ready barcoding history.'
    ]
  },
  {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-16">
      ...
      <SEO
        ...
        description="Discover StockFlow Scanâ€”the barcode scanning workflow that keeps omnichannel inventory accurate. Learn how teams capture UPC, QR, and GS1 codes in seconds."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
              StockFlow Barcoding powers inventory teams with rapid data capture, validation, and automationâ€”without the friction of installing traditional scanning apps.
            </p>
          </div>
      ...
      <div id="how-it-works" className="bg-white py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">How StockFlow Barcoding Works</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              From high-volume retail to regulated warehousing, StockFlow Barcoding adapts to your SOPs, devices, and reporting needs.
            </p>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-2 items-start">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                StockFlow Barcoding is web-first, so you can onboard teams instantly. Share a secure link, configure workflows, and monitor adoption without waiting on app store approvals or device imaging.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Enforce SOPs with role-based permissions, device telemetry, and detailed audit logs for every barcoding.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
            ...
            <div className="rounded-3xl bg-gray-50 p-8 border border-gray-200">
              ...
              <ul className="space-y-4 text-gray-600">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>Full audit trails and exports ensure every barcoding is traceable for compliance checks.</span>
                </li>
              </ul>
            </div>
          </div>
