        ...
        <div className="grid lg:grid-cols-[1.4fr_1fr] gap-10 items-center">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-blue-100">
            ...
            <ul className="mt-4 space-y-3 text-sm text-gray-700">
              <li>✅ Automated purchase orders and supplier portals</li>
              <li>✅ Real-time visibility across warehouses & stores</li>
              <li>✅ Barcode picking, packing, and cycle counts</li>
              <li>✅ Analytics dashboard for finance & demand planning</li>
            </ul>
          </div>
        </div>
      </section>
