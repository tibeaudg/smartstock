...
export default function FreeInventoryApp() {
  usePageRefresh();
  
  return (
    <SeoPageLayout title="Free Inventory App">
      <SEO
        ...
        url="https://www.stockflow.be/free-inventory-app"
      />
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Free Inventory App: <span className="text-blue-600">Mobile Inventory Management at No Cost</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Download our free inventory app. Manage stock from your phone or tablet. Free for up to 30 products.
              </p>
