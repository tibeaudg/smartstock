...
export default function HomeInventoryApp() {
  ...
  return (
    <SeoPageLayout title="Home Inventory App">
      <SEO
        ...
        url="https://www.stockflow.be/home-inventory-app"
      />
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Home Inventory App: <span className="text-blue-600">Organize and Protect Your Personal Belongings</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Manage your home inventory with ease. Track belongings, organize storage, and keep records for insurance.
              </p>
