...
export default function MagazijnbeheerSoftware() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Ja, moderne magazijnbeheer software zoals StockFlow kan vaak geïntegreerd worden met boekhoudsoftware, webshops en andere bedrijfssystemen voor een naadloze workflow."
    }
  ];
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="bg-green-50 p-3 sm:p-4 rounded-lg">
                  ...
                  <p className="text-xs sm:text-sm text-gray-700">Beheer meerdere magazijnen of vestigingen vanuit één centraal systeem.</p>
                </div>
                <div className="bg-purple-50 p-3 sm:p-4 rounded-lg">
                  <h3 className="text-sm sm:text-base font-semibold text-purple-800 mb-2">Automatische processen</h3>
                  <p className="text-xs sm:text-sm text-gray-700">Automatiseer inkomende en uitgaande goederenstromen voor maximale efficiëntie.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700">
                Beheer voorraad op meerdere magazijnen vanuit één centrale magazijnbeheer software. Ideaal voor bedrijven met meerdere vestigingen.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700">
                Krijg automatisch rapporten over je magazijnprestaties, voorraadrotatie en efficiëntie.
              </p>
            </div>
