          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Inventory Management for Bakeries: <span className="text-blue-600">Tailored for Bakers and Pastry Shops</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Specialized inventory for bakeries. Track ingredients, manage recipes, reduce waste, and control costs.
              </p>
            ...
            <div>
              <img 
                ...
                alt="Inventory Management for Bakeries" 
