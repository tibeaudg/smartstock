...
const metaDescription = "Deep dive into Calculating Raw Materials Inventory. Learn practical ideas, implementation steps, and metrics so your team can apply Calculating Raw Materials Inventory with StockFlow.";
const keywords = "Calculating Raw Materials Inventory, Calculating Raw Materials Inventory guide, Calculating Raw Materials Inventory best practices, Calculating Raw Materials Inventory StockFlow, inventory management, operations playbook";
...
const faqData = [
  {
    ...
    "answer": "Calculating Raw Materials Inventory refers to the practices, insights, or stories captured in the original Sortly blog article. This guide reframes the topic for StockFlow users who want to move faster, stay organized, and build resilient inventory operations."
  },
  {
