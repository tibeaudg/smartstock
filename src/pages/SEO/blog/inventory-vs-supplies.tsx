...
const metaDescription = "Deep dive into Inventory Vs Supplies. Learn practical ideas, implementation steps, and metrics so your team can apply Inventory Vs Supplies with StockFlow.";
const keywords = "Inventory Vs Supplies, Inventory Vs Supplies guide, Inventory Vs Supplies best practices, Inventory Vs Supplies StockFlow, inventory management, operations playbook";
...
const faqData = [
  {
    ...
    "answer": "Inventory Vs Supplies refers to the practices, insights, or stories captured in the original Sortly blog article. This guide reframes the topic for StockFlow users who want to move faster, stay organized, and build resilient inventory operations."
  },
  {
