...
const metaDescription = "Deep dive into Perpetual Inventory And Physical Inventory. Learn practical ideas, implementation steps, and metrics so your team can apply Perpetual Inventory And Physical Inventory with StockFlow.";
const keywords = "Perpetual Inventory And Physical Inventory, Perpetual Inventory And Physical Inventory guide, Perpetual Inventory And Physical Inventory best practices, Perpetual Inventory And Physical Inventory StockFlow, inventory management, operations playbook";
...
const faqData = [
  {
    ...
    "answer": "Perpetual Inventory And Physical Inventory refers to the practices, insights, or stories captured in the original Sortly blog article. This guide reframes the topic for StockFlow users who want to move faster, stay organized, and build resilient inventory operations."
  },
  {
