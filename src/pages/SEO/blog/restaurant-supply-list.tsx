...
const faqData = [
  {
    ...
    "answer": "Restaurant Supply List refers to the practices, insights, or stories captured in the original Sortly blog article. This guide reframes the topic for StockFlow users who want to move faster, stay organized, and build resilient inventory operations."
  },
  {
