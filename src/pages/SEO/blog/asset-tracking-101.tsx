...
const metaDescription = "Deep dive into Asset Tracking 101. Learn practical ideas, implementation steps, and metrics so your team can apply Asset Tracking 101 with StockFlow.";
const keywords = "Asset Tracking 101, Asset Tracking 101 guide, Asset Tracking 101 best practices, Asset Tracking 101 StockFlow, inventory management, operations playbook";
...
const faqData = [
  {
    ...
    "answer": "Asset Tracking 101 refers to the practices, insights, or stories captured in the original Sortly blog article. This guide reframes the topic for StockFlow users who want to move faster, stay organized, and build resilient inventory operations."
  },
  {
