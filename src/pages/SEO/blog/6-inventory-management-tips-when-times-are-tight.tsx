...
const metaDescription = "Deep dive into 6 Inventory Management Tips When Times Are Tight. Learn practical ideas, implementation steps, and metrics so your team can apply 6 Inventory Management Tips When Times Are Tight with StockFlow.";
const keywords = "6 Inventory Management Tips When Times Are Tight, 6 Inventory Management Tips When Times Are Tight guide, 6 Inventory Management Tips When Times Are Tight best practices, 6 Inventory Management Tips When Times Are Tight StockFlow, inventory management, operations playbook";
...
const faqData = [
  {
    ...
    "answer": "6 Inventory Management Tips When Times Are Tight refers to the practices, insights, or stories captured in the original Sortly blog article. This guide reframes the topic for StockFlow users who want to move faster, stay organized, and build resilient inventory operations."
  },
  {
