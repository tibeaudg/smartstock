...
const metaDescription = "Deep dive into How To Inventory Your Tools. Learn practical ideas, implementation steps, and metrics so your team can apply How To Inventory Your Tools with StockFlow.";
const keywords = "How To Inventory Your Tools, How To Inventory Your Tools guide, How To Inventory Your Tools best practices, How To Inventory Your Tools StockFlow, inventory management, operations playbook";
...
const faqData = [
  {
    ...
    "answer": "How To Inventory Your Tools refers to the practices, insights, or stories captured in the original Sortly blog article. This guide reframes the topic for StockFlow users who want to move faster, stay organized, and build resilient inventory operations."
  },
  {
