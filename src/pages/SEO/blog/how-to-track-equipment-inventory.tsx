...
const metaDescription = "Deep dive into How To Track Equipment Inventory. Learn practical ideas, implementation steps, and metrics so your team can apply How To Track Equipment Inventory with StockFlow.";
const keywords = "How To Track Equipment Inventory, How To Track Equipment Inventory guide, How To Track Equipment Inventory best practices, How To Track Equipment Inventory StockFlow, inventory management, operations playbook";
...
const faqData = [
  {
    ...
    "answer": "How To Track Equipment Inventory refers to the practices, insights, or stories captured in the original Sortly blog article. This guide reframes the topic for StockFlow users who want to move faster, stay organized, and build resilient inventory operations."
  },
  {
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-3">
              <div className="rounded-2xl border border-white/30 bg-white/10 p-5">
                ...
                <p className="mt-3 text-sm text-white/85">
                  Centralize item masters, stock movements, suppliers, and documents so how to track equipment inventory decisions never rely on outdated spreadsheets.
                </p>
              </div>
              <div className="rounded-2xl border border-white/30 bg-white/10 p-5">
                <h3 className="text-lg font-semibold">Automation & alerts</h3>
                <p className="mt-3 text-sm text-white/85">
                  Trigger workflows, approvals, and reorder points when how to track equipment inventory KPIs drift from plan.
                </p>
              </div>
              <div className="rounded-2xl border border-white/30 bg-white/10 p-5">
                <h3 className="text-lg font-semibold">Collaboration built in</h3>
                <p className="mt-3 text-sm text-white/85">
                  Give finance, operations, and frontline teams a shared system of record for how to track equipment inventory progress.
                </p>
              </div>
            </div>
          </div>
