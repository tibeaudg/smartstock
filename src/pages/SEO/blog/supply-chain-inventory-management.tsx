...
const metaDescription = "Deep dive into Supply Chain Inventory Management. Learn practical ideas, implementation steps, and metrics so your team can apply Supply Chain Inventory Management with StockFlow.";
const keywords = "Supply Chain Inventory Management, Supply Chain Inventory Management guide, Supply Chain Inventory Management best practices, Supply Chain Inventory Management StockFlow, inventory management, operations playbook";
...
const faqData = [
  {
    ...
    "answer": "Supply Chain Inventory Management refers to the practices, insights, or stories captured in the original Sortly blog article. This guide reframes the topic for StockFlow users who want to move faster, stay organized, and build resilient inventory operations."
  },
  {
