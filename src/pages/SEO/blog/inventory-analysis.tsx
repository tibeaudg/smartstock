...
const metaDescription = "Deep dive into Inventory Analysis. Learn practical ideas, implementation steps, and metrics so your team can apply Inventory Analysis with StockFlow.";
const keywords = "Inventory Analysis, Inventory Analysis guide, Inventory Analysis best practices, Inventory Analysis StockFlow, inventory management, operations playbook";
...
const faqData = [
  {
    ...
    "answer": "Inventory Analysis refers to the practices, insights, or stories captured in the original Sortly blog article. This guide reframes the topic for StockFlow users who want to move faster, stay organized, and build resilient inventory operations."
  },
  {
