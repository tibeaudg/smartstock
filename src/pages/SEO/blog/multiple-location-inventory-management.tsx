...
const canonicalPath = "/multiple-location-inventory-management";
...
const structuredData = [
  {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.stockflowsystems.com/multiple-location-inventory-management"
    }
  }
];
    ...
    >
      ...
      <section id="overview" className="bg-white px-4 py-16">
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1.4fr_1fr]">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl">Multiple Location Inventory Management</h1>
