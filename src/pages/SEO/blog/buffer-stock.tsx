...
const metaDescription = "Deep dive into Buffer Stock. Learn practical ideas, implementation steps, and metrics so your team can apply Buffer Stock with StockFlow.";
const keywords = "Buffer Stock, Buffer Stock guide, Buffer Stock best practices, Buffer Stock StockFlow, inventory management, operations playbook";
...
const faqData = [
  {
    ...
    "answer": "Buffer Stock refers to the practices, insights, or stories captured in the original Sortly blog article. This guide reframes the topic for StockFlow users who want to move faster, stay organized, and build resilient inventory operations."
  },
  {
