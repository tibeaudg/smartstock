...
const topicTitle = "2023 Sortly Wrapped";
const canonicalPath = "/blog/2023-sortly-wrapped";
const metaDescription = "Deep dive into 2023 Sortly Wrapped. Learn practical ideas, implementation steps, and metrics so your team can apply 2023 Sortly Wrapped with StockFlow.";
const keywords = "2023 Sortly Wrapped, 2023 Sortly Wrapped guide, 2023 Sortly Wrapped best practices, 2023 Sortly Wrapped StockFlow, inventory management, operations playbook";
const heroBadge = "Topic Guide • Updated December 2023";
const summaryCopy = "Explore 2023 Sortly Wrapped through the lens of modern inventory and operations leadership. This StockFlow-exclusive guide synthesizes the best lessons from the original Sortly article and translates them into actionable steps for teams that need structure, visibility, and measurable wins.";
const takeaways = [
  "Understand the core themes behind 2023 Sortly Wrapped and why they matter for modern operations teams.",
  "Follow a structured framework to translate 2023 Sortly Wrapped into day-to-day improvements.",
  "Highlight StockFlow capabilities that make 2023 sortly wrapped sustainable at scale."
];
const actionSteps = [
  {
    "title": "Align on the outcome",
    "description": "Confirm what 2023 sortly wrapped should deliver for customers, finance, and frontline teams."
  },
  {
    "title": "Audit current workflows",
    "description": "Document how 2023 sortly wrapped happens today, where gaps exist, and which systems hold the data."
  },
  {
    "title": "Launch targeted improvements",
    "description": "Prototype a lean version of 2023 sortly wrapped inside StockFlow, measure the impact, and expand in sprints."
  }
];
const metrics = [
  {
    "label": "Execution velocity",
    "detail": "Track how quickly 2023 sortly wrapped initiatives move from idea to rollout."
  },
  {
    "label": "Team adoption",
    "detail": "Measure participation rates in the new 2023 sortly wrapped process across locations or departments."
  },
  {
    "label": "Quality & accuracy",
    "detail": "Monitor error rates, rework, or data accuracy tied to 2023 sortly wrapped workflows."
  }
];
const faqData = [
  {
    "question": "What is 2023 Sortly Wrapped?",
    "answer": "2023 Sortly Wrapped refers to the practices, insights, or stories captured in the original Stockflow article. This guide reframes the topic for StockFlow users who want to move faster, stay organized, and build resilient inventory operations."
  },
  {
    "question": "How can I get started with 2023 sortly wrapped?",
    "answer": "Start by clarifying the objective, mapping the stakeholders, and collecting baseline metrics. Use the action playbook in this article to pilot 2023 sortly wrapped within one team, then expand once you capture early wins."
  },
  {
    "question": "Where does StockFlow add value for 2023 sortly wrapped?",
    "answer": "StockFlow centralizes data, automates alerts, and connects cross-functional teams. That means fewer spreadsheets, faster decisions, and the ability to prove the value of 2023 sortly wrapped with real-time dashboards."
  }
];
const structuredData = [
  {
    ...
    "@type": "Article",
    "headline": "2023 Sortly Wrapped",
    "description": "Deep dive into 2023 Sortly Wrapped. Learn practical ideas, implementation steps, and metrics so your team can apply 2023 Sortly Wrapped with StockFlow.",
    "author": {
      "@type": "Organization",
      "name": "StockFlow"
    },
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.stockflow.be/blog/2023-sortly-wrapped"
    }
  }
];

export default function Seo2023SortlyWrappedPage() {
  usePageRefresh();
  ...
  return (
    <SeoPageLayout title={topicTitle} showSidebar sidebarContent={sidebarContent}>
      <SEO
        title={`2023 Sortly Wrapped 2025 - 2023 Sortly Wrapped`}
      ...
      />
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">2023 Sortly Wrapped</h1>
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-3">
              <div className="rounded-2xl border border-white/30 bg-white/10 p-5">
                ...
                <p className="mt-3 text-sm text-white/85">
                  Centralize item masters, stock movements, suppliers, and documents so 2023 sortly wrapped decisions never rely on outdated spreadsheets.
                </p>
              </div>
              <div className="rounded-2xl border border-white/30 bg-white/10 p-5">
                <h3 className="text-lg font-semibold">Automation & alerts</h3>
                <p className="mt-3 text-sm text-white/85">
                  Trigger workflows, approvals, and reorder points when 2023 sortly wrapped KPIs drift from plan.
                </p>
              </div>
              <div className="rounded-2xl border border-white/30 bg-white/10 p-5">
                <h3 className="text-lg font-semibold">Collaboration built in</h3>
                <p className="mt-3 text-sm text-white/85">
                  Give finance, operations, and frontline teams a shared system of record for 2023 sortly wrapped progress.
                </p>
              </div>
            </div>
          </div>
