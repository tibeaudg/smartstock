...
const faqData = [
  {
    ...
    "answer": "Construction Invoice Processing refers to the practices, insights, or stories captured in the original Stockflow article. This guide reframes the topic for StockFlow users who want to move faster, stay organized, and build resilient inventory operations."
  },
  {
