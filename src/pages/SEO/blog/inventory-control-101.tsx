...
const metaDescription = "Deep dive into Inventory Control 101. Learn practical ideas, implementation steps, and metrics so your team can apply Inventory Control 101 with StockFlow.";
const keywords = "Inventory Control 101, Inventory Control 101 guide, Inventory Control 101 best practices, Inventory Control 101 StockFlow, inventory management, operations playbook";
...
const faqData = [
  {
    ...
    "answer": "Inventory Control 101 refers to the practices, insights, or stories captured in the original Sortly blog article. This guide reframes the topic for StockFlow users who want to move faster, stay organized, and build resilient inventory operations."
  },
  {
