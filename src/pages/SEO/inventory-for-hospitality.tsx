          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Inventory for Hospitality: <span className="text-blue-600">Specialized Solutions for the Hospitality Industry</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Optimize inventory for hospitality businesses. Track F&B, supplies, and equipment efficiently.
              </p>
