          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Stock Management App: <span className="text-blue-600">Control Your Inventory Anywhere, Anytime</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Manage your stock on-the-go with our mobile app. Real-time tracking, barcode scanning, and instant updates from anywhere.
              </p>
