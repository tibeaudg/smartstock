...
export default function InventoryForStarters() {
  usePageRefresh();
  
  return (
    <SeoPageLayout title="Inventory Management for Beginners">
      <SEO
        ...
        url="https://www.stockflow.be/inventory-for-starters"
      />
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Inventory Management for Beginners: <span className="text-blue-600">Everything You Need to Get Started</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                New to inventory management? Learn the basics with our complete beginner guide. Start managing stock like a pro.
              </p>
            ...
            <div>
              <img 
                ...
                alt="Inventory Management for Beginners" 
