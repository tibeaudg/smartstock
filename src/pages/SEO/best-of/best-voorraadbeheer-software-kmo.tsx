                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <h4 className="font-semibold text-red-700 mb-3 flex items-center">
                          <span className="h-5 w-5 mr-2">âš ï¸</span>
                          Nadelen
                        </h4>
                        <ul className="space-y-2">
                          {solution.cons.map((con, i) => (
                            <li key={i} className="flex items-start gap-2 text-sm text-gray-600">
                              <span className="text-red-400 flex-shrink-0 mt-0.5">âˆ’</span>
                              <span>{con}</span>
                            </li>
                          ))}
                        </ul>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">EÃ©n of meerdere vestigingen?</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0 mt-0.5">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                StockFlow wordt vaak genoemd als meest gebruiksvriendelijk, met een intuÃ¯tieve interface 
