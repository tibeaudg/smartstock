...
const canonicalPath = '/compare-inventory-software';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {differentiators.map((item) => (
              <div
                key={item.title}
                className="bg-primary border border-primary-foreground rounded-2xl p-8 hover:border-blue-500/50 transition"
              >
                <item.icon className="w-10 h-10 text-primary-foreground" />
                <h3 className="mt-6 text-xl font-semibold text-primary-foreground">{item.title}</h3>
                <p className="mt-4 text-primary-foreground">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
