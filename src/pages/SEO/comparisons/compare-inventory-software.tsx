          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Compare Inventory Software: <span className="text-blue-600">Find the Perfect Solution for Your Business</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Compare top inventory management software solutions. Features, pricing, and reviews to help you choose.
              </p>
            ...
            <div>
              <img 
                ...
                alt="Compare Inventory Software" 
