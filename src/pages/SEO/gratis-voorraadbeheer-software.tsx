...
import { Check, Gift, Zap, Shield, Users, TrendingUp, Star, BarChart3, Smartphone } from 'lucide-react';
...
export default function GratisVoorraadbeheerSoftware() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Onze gratis voorraadbeheer software bevat alle essentiële functies: real-time voorraadoverzicht, automatische bestelmeldingen, barcode scanning, team samenwerking, rapportages, en integratie met andere systemen. Alles wat je nodig hebt voor professioneel voorraadbeheer."
    },
    {
    ...
    },
    {
      ...
      answer: "Ja, onze gratis voorraadbeheer software kan eenvoudig geïntegreerd worden met populaire boekhoudsystemen. Dit zorgt voor automatische synchronisatie van voorraadgegevens en bespaart je veel tijd."
    },
    {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Bekijk real-time rapportages, stel automatische bestellingen in en beheer je voorraad efficiënt.
              </p>
            </div>
          </div>
        </div>
