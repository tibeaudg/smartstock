  ...
  return (
    ...
    >
      <SEO
        ...
        locale="en"
        alternateLanguages={[
          { lang: 'en-US', url: 'https://www.stockflow.be/inventory-turnover-ratio' }
        ]}
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Everything you need to know about inventory turnover ratio</p>
          </div>
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Optimize Your Inventory Turnover Ratio Today
          </h2>
          <p className="text-xl md:text-2xl mb-12 opacity-90 max-w-3xl mx-auto">
            Use StockFlow to track, calculate, and improve your inventory turnover ratio automatically. 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link
              to="/auth"
              className="bg-white text-blue-600 px-10 py-5 rounded-xl font-bold text-xl hover:bg-gray-100 transition shadow-2xl"
            >
              Start Free Trial
            </Link>
          </div>
      ...
      <footer className="bg-gray-900 text-gray-200 py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 text-base md:text-lg mb-8 leading-relaxed max-w-2xl mx-auto">
            Professional inventory management software for optimizing inventory turnover ratios and improving business performance.
          </p>

          <div className="border-t border-gray-700 pt-6">
            <p className="text-gray-500 text-xs md:text-sm">
              &copy; {new Date().getFullYear()} StockFlow. All rights reserved.
              Inventory turnover ratio optimization tools.
            </p>
          </div>
        </div>
      </footer>
      ...
      <StructuredData data={[
        ...
        },
        {
          ...
          "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": "https://www.stockflow.be/inventory-turnover-ratio"
          },
