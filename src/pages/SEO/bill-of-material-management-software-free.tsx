        ...
        <div className="max-w-6xl mx-auto px-4 grid lg:grid-cols-[1.4fr_1fr] gap-10 items-center">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 shadow-sm">
            ...
            <ul className="mt-4 space-y-3 text-sm text-gray-700">
              <li>✅ Multi-level BOMs with component versioning</li>
              <li>✅ Automatic cost roll-ups and margin tracking</li>
              <li>✅ Purchase suggestions for raw materials</li>
              <li>✅ Mobile barcode app for production picks</li>
            </ul>
          </div>
        </div>
      </section>
