...
const faqData = [
  {
    ...
    answer: 'StockFlow combineert voorraadbeheer, receptkostprijsberekening en automatische bestellijsten zodat restaurants, cafés en cateringbedrijven direct inzicht hebben in marges en voorraadniveaus.'
  },
  {
    question: 'Werkt StockFlow met meerdere vestigingen?',
    answer: 'Ja. Met multi-locatie beheer verdeel je voorraad over verschillende keukens, bars of foodtrucks en hou je alles in één dashboard bij.'
  },
  {
    question: 'Kan ik leveranciers en bestellingen automatiseren?',
    answer: 'Via slimme bestelpunten stuurt StockFlow automatisch bestelaanvragen naar je vaste leveranciers wanneer ingrediënten bijna op zijn.'
  },
  {
...
const structuredData = generateComprehensiveStructuredData('software', {
  ...
  description:
    'Voorraadbeheer software voor horeca: beheer recepten, kostprijzen en leveranciers in één systeem. Verlaag voedselverspilling en verhoog marges.',
  breadcrumbs: [
  ...
  return (
    <SeoPageLayout title="Voorraadbeheer voor Horeca">
      <SEO
        ...
        description="Digitaliseer je horecavoorraden met StockFlow. Receptbeheer, kostprijsanalyse, houdbaarheid en bestellingen in één dashboard. Start gratis."
        ...
        <div className="grid lg:grid-cols-[1.4fr_1fr] gap-10 items-center">
          <div>
            ...
            <p className="text-base sm:text-lg text-gray-700 mt-5 leading-relaxed">
              Monitor voorraad van frigo tot tapinstallatie, zie realtime kostprijzen per gerecht en automatiseer bestellingen. StockFlow geeft horecaondernemers volledige controle over ingrediënten, menu’s en marge.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-orange-100">
            ...
            <ul className="mt-4 space-y-3 text-sm text-gray-700">
              <li>✅ Receptuur en kostprijs per gerecht</li>
              <li>✅ Houdbaarheid- en allergenenbeheer</li>
              <li>✅ Team-app voor telrondes & barcodes</li>
              <li>✅ Automatische besteladviezen per leverancier</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
              ...
              <p className="text-sm text-gray-600 mt-2">Bekijk voorraadwaardes, marge per gerecht en verwachte tekorten in één overzicht.</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
