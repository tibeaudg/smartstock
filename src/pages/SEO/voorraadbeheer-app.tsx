...
export default function VoorraadbeheerApp() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "De voorraadbeheer app bevat alle essentiële functies: voorraad bijhouden, bestellingen plaatsen, barcode scannen, voorraadbewegingen registreren en real-time inzicht in je voorraadniveaus."
    }
  ];
          ...
          <div className="grid lg:grid-cols-3 gap-4 items-center">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                ...
                Met barcode scanning, real-time synchronisatie en een gebruiksvriendelijke interface maakt onze voorraadbeheer app voorraadbeheer eenvoudig en efficiënt. 
          ...
          <div className="grid lg:grid-cols-3 gap-4 items-start">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-lg text-gray-700 mb-8">
                Onze voorraadbeheer app bevat alle essentiële functies die je nodig hebt voor efficiënt voorraadbeheer:
              </p>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    Deze functie maakt onze voorraadbeheer app bijzonder efficiënt voor magazijnoperaties.
                  </p>
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold mb-4">Verhoogde efficiëntie</h3>
              <p className="text-gray-700">
                Met onze voorraadbeheer app kun je tot 50% sneller werken dan met traditionele methoden. 
                Barcode scanning en mobiele toegang maken voorraadbeheer veel efficiënter en nauwkeuriger.
              </p>
            </div>
