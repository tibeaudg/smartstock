...
export default function ProgrammaStockbeheer() {
  ...
  const faqData = [
    ...
    {
      question: "Wat zijn de belangrijkste functies van stockbeheer software?",
    ...
    {
      question: "Hoeveel kost stockbeheer software per maand?",
      answer: `Kosten variëren per aanbieder. StockFlow biedt een volledig gratis plan voor tot 30 producten. Premium plannen beginnen vanaf ${formatPrice(29)} per maand voor onbeperkte producten en geavanceerde functies. Dit is veel goedkoper dan traditionele ERP systemen die vaak €100-500+ per maand kosten. De meeste bedrijven besparen meer dan ze uitgeven door betere voorraadoptimalisatie.`
    },
    {
      question: "Kan ik stockbeheer software gebruiken op mijn mobiele telefoon?",
      answer: "Ja, de meeste moderne stockbeheer software zoals StockFlow biedt mobiele apps voor iOS en Android. Hiermee kun je voorraad tellen met barcode scanning, bestellingen plaatsen, voorraadniveaus bekijken en meldingen ontvangen - allemaal vanaf je smartphone of tablet. Perfect voor magazijnmedewerkers en managers die onderweg zijn."
    },
    {
      question: "Is stockbeheer software geschikt voor kleine bedrijven?",
      answer: "Absoluut! Moderne stockbeheer software zoals StockFlow is speciaal ontworpen voor kleine bedrijven en KMO's. Gratis plannen maken het toegankelijk, en de software schaalt mee met je groei. Veel kleine bedrijven besparen 10-15 uur per week en honderden euro's per maand door betere voorraadcontrole."
    },
    {
      question: "Hoe voorkom ik fouten met stockbeheer software?",
      answer: "Stockbeheer software voorkomt fouten door: automatische voorraadupdates (geen handmatige invoer), barcode scanning voor 99.9% nauwkeurigheid, real-time synchronisatie tussen alle systemen, automatische validatie van data, en duidelijke workflows. Dit reduceert fouten met 90% vergeleken met handmatige methodes."
    }
  ];
