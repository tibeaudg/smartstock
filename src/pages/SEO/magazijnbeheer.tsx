...
export default function Magazijnbeheer() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Essentiële functies zijn: multi-locatie support, barcode scanning, zone en bin management, picking en packing workflows, shipping integratie, mobiele toegang voor het warehouse team, en real-time voorraad tracking per locatie."
    },
    {
      question: "Is magazijnbeheer software geschikt voor kleine magazijnen?",
      answer: "Absoluut! Moderne magazijnbeheer software is schaalbaar. Stockflow is perfect voor zowel kleine magazijnen met één locatie als grote operations met meerdere warehouses. Je betaalt alleen voor wat je nodig hebt."
    },
    {
  ...
  const magazijnFeatures = [
    {
      ...
      description: "Beheer meerdere magazijnen, zones en stellingen vanuit één centraal systeem.",
      color: "blue"
    },
    {
      icon: Smartphone,
    ...
    },
    {
      ...
      description: "Geoptimaliseerde workflows voor efficiënte order picking en verpakking.",
      color: "purple"
    },
    {
      icon: Users,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Magazijnbeheer Software voor <span className="text-yellow-300">Efficiënte</span> Warehouses
              </h1>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-6 rounded-xl text-center">
            <p className="text-lg">
              <strong>Het beste van beide?</strong> Stockflow combineert voorraadbeheer én magazijnbeheer in één platform. 
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Alles wat je nodig hebt voor efficiënte warehouse operaties
            </p>
          </div>
