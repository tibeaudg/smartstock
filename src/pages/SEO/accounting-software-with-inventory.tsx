...
export default function AccountingSoftwareWithInventory() {
  usePageRefresh();
  
  return (
    <SeoPageLayout title="Accounting Software with Inventory">
      <SEO
        ...
        url="https://www.stockflow.be/accounting-software-with-inventory"
      />
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                Accounting Software with Inventory: <span className="text-blue-600">All-in-One Financial & Stock Management</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8">
                Combine accounting and inventory in one platform. Streamline finances and stock control together.
              </p>
            ...
            <div>
              <img 
                ...
                alt="Accounting Software with Inventory" 
