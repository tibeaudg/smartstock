...
const keyTakeaways = [
  ...
  'Enhanced visibility into hospital supply chain management best practices cycles reduces carrying costs and frees up working capital for strategic investment.',
];
