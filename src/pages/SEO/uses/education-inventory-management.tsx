      ...
      <section id="faq" className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Everything schools need to know about inventory management</p>
          </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-gray-50 to-indigo-50">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-gray-200">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Transform Your School's Inventory?</h2>
            <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
              Join hundreds of schools reducing loss, optimizing budgets, and demonstrating accountability with StockFlow's education inventory management software.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link 
                to="/auth" 
            ...
            <p className="text-sm text-gray-600 mt-6">
              Free plan • Education pricing • No credit card required
            </p>
          </div>
        </div>
      </section>
