...
export default function SoftwareStockbeheer() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Ja, moderne software stockbeheer zoals StockFlow kan vaak geïntegreerd worden met boekhoudsoftware, webshops en andere bedrijfssystemen voor een naadloze workflow."
    }
  ];
  ...
  return (
    <SeoPageLayout title="Software Stockbeheer voor Kleine Bedrijven">
      <SEO
        title="Gratis Software Stockbeheer voor KMO's | StockFlow"
        description="Eenvoudig software stockbeheer voor kleine bedrijven. Beheer voorraad, leveringen en producten in één online dashboard. Gratis te proberen."
        keywords="software stockbeheer, stockbeheer software, gratis stockbeheer, voorraadbeheer software, magazijnbeheer software, inventarisatie software, KMO software"
        url="https://www.stockflow.be/software-stockbeheer"
          ...
          <div className="grid lg:grid-cols-3 gap-6 sm:gap-8 items-center">
            <div className="lg:col-span-2">
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-700 mb-6 sm:mb-8 leading-relaxed">
                Eenvoudig software stockbeheer voor kleine bedrijven. Beheer voorraad, leveringen en producten in één online dashboard. Real-time inzicht, barcode scanning en automatische meldingen. Gratis te proberen voor KMO's!
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700">
                Beheer voorraad op meerdere locaties vanuit één centrale software stockbeheer. Ideaal voor bedrijven met meerdere vestigingen.
              </p>
            </div>
