...
import StockManagement from "./pages/SEO/stock-management";
...
import InventoryForStarters from "./pages/SEO/inventory-for-starters";
import AutomateInventoryManagement from "./pages/SEO/automate-inventory-management";
import InventoryExcel from "./pages/SEO/inventory-excel";
import FreeInventoryExcelTemplate from "./pages/SEO/free-inventory-excel-template";
import InventoryExcelVsSoftware from "./pages/SEO/inventory-excel-vs-software";
import AvoidInventoryMistakes from "./pages/SEO/avoid-inventory-mistakes";
import InventoryManagementHospitality from "./pages/SEO/inventory-management-hospitality";
import CompareInventorySoftware from "./pages/SEO/compare-inventory-software";
import InventoryForHospitality from "./pages/SEO/inventory-for-hospitality";
import InventoryForEcommerce from "./pages/SEO/inventory-for-ecommerce";
import HomeInventoryApp from "./pages/SEO/home-inventory-app";
import AccountingSoftwareWithInventory from "./pages/SEO/accounting-software-with-inventory";
import FreeWarehouseSoftware from "./pages/SEO/free-warehouse-software";
import FreeStockProgram from "./pages/SEO/free-stock-program";
    ...
    <ContentWrapper>
      <Routes>
        ...
        <Route path="/voorraadbeheer-voor-horeca" element={<VoorraadbeheerVoorHoreca />} />
                  ...
                  <Route path="/inventory-for-starters" element={<InventoryForStarters />} />
                  <Route path="/automate-inventory-management" element={<AutomateInventoryManagement />} />
                  <Route path="/inventory-excel" element={<InventoryExcel />} />
                  <Route path="/free-inventory-excel-template" element={<FreeInventoryExcelTemplate />} />
                  <Route path="/inventory-excel-vs-software" element={<InventoryExcelVsSoftware />} />
                  <Route path="/avoid-inventory-mistakes" element={<AvoidInventoryMistakes />} />
                  <Route path="/inventory-management-hospitality" element={<InventoryManagementHospitality />} />
                  <Route path="/compare-inventory-software" element={<CompareInventorySoftware />} />
                  <Route path="/inventory-for-hospitality" element={<InventoryForHospitality />} />
                  <Route path="/inventory-for-ecommerce" element={<InventoryForEcommerce />} />
                  <Route path="/home-inventory-app" element={<HomeInventoryApp />} />
                  <Route path="/accounting-software-with-inventory" element={<AccountingSoftwareWithInventory />} />
                  <Route path="/free-warehouse-software" element={<FreeWarehouseSoftware />} />
                  <Route path="/free-stock-program" element={<FreeStockProgram />} />
                  <Route path="/simple-stock-management" element={<SimpleStockManagement />} />
                  <Route path="/inventory-management-bakery" element={<InventoryManagementBakery />} />
                  <Route path="/create-inventory-excel" element={<CreateInventoryExcel />} />
