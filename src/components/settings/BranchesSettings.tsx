...
export const BranchesSettings = () => {
  ...
  const doDelete = async () => {
    ...
    if (branches.length <= 1) {
      toast.error('You must have at least one warehouse.');
      return;
    }
    setDeleting(true);
    try {
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Edit, delete, or add new warehouses.
              </CardDescription>
            </div>
      ...
      <AlertDialog open={!!deleteId} onOpenChange={() => !deleting && setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the warehouse and all associated data. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
